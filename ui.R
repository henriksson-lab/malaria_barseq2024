            ...
            wellPanel(
              ...
              #div(class = "label-left",
                ...
                selectInput(
                  ...
                  label = "Color by:",
                  multiple = FALSE,
                  choices = c("Gene","Mouse","Genotype","Treatment","Genotype+Treatment"), 
                  selected = c("Gene")
                ),
...
tab_about <- fluidPage(
  ...
  p(
    "This is an interactive Shiny-based app that visualises the analysed data for BARseq screens in the rodent malaria parasite Plasmodium berghei as described in Ivanova et al. ",
    "DOI: ", tags$a(href="https://doi.org/todo", "https://doi.org/todo")
  ),
  p(
...
ui <- fluidPage(
  ...
  titlePanel("Bushell lab malaria BAR-seq KO screen viewer 2024"),
